-This is a web project inspired by The Coffee House using ASP.NET MVC and using entity framework to generate model which simulate this website: https://thecoffeehouse.com/
